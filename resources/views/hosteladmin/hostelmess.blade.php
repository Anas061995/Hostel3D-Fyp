...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
      <div class= "row content container-fluid">
        <!-- Card -->
    <div class="card col-md-3 " style=" padding:25px;">
      <!-- Card image -->
      <img class="card-img-top"style="height: 175px; width:100%;" src="{{asset('asset/img/foodlist.jpg')}}" alt="Card image cap" >
      <!-- Card content -->
      <div class="card-body">
        <!-- Title -->
        <h4 class="card-title"><a>Food List</a></h4>
        <!-- Text -->
        <p  style= "font-size: small !important;" class="card-text">List of food items served to residents that avail mess services</p>
        <!-- Button -->
        <a href="{{route('hosteladmin.foodlist')}}" style="margin-left: 48px;" class="btn btn-primary">VIEW</a>
      </div>
    </div>
    <!-- Card -->

    <!-- Card -->
<div class="card col-md-3 col-md-offset-1"  style=" padding:25px;">
  <!-- Card image -->
  <img class="card-img-top"style=" height: 175px; width:100%;" src="{{asset('asset/img/menu.png')}}" alt="Card image cap" >
  <!-- Card content -->
  <div class="card-body">
    <!-- Title -->
    <h4 class="card-title"><a>Mess Menus</a></h4>
    <!-- Text -->
    <p style ="font-size: small;" class="card-text">List of Mess Menu of different categories such as breakfast, lunch and dinner</p>
    <!-- Button -->
    <a href="{{route('hosteladmin.messmenus')}}" style="margin-left: 48px;" class="btn btn-primary">VIEW</a>
  </div>
</div>
<!-- Card -->
<!-- Card -->
<div class="card col-md-3 col-md-offset-1"  style=" padding:25px;">
<!-- Card image -->
<img class="card-img-top"style=" height: 175px; width:100%;" src="{{asset('asset/img/publish.jpg')}}" alt="Card image cap" >
<!-- Card content -->
<div class="card-body">
<!-- Title -->
<h4 class="card-title"><a> Publish Mess Menu</a></h4>
<!-- Text -->
<p style= "font-size: small;" class="card-text">List of Mess Menu of different categories such as breakfast, lunch and dinner</p>
<!-- Button -->
<a href="#" style="margin-left: 48px;" onclick="ShowModal(this)" class="btn btn-primary">PUBLISH</a>
</div>
</div>
<!-- Card -->
